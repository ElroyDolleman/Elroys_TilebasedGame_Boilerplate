...
export class TimeUtil
{
	...
	public static millisecondsToFrames(ms: number): number
	{
		return Math.ceil(ms / this.elapsedMS);
	}

	public static secondsToFrames(seconds: number): number
	{
		return Math.ceil(seconds / this.elapsedSeconds);
	}
